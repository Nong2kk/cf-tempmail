...
const PREVIEW_SCAN_CHARS = 10000; // was 3000 — heavy transactional-email templates (e.g. ChatGPT's) can have 3000+ raw chars of markup/CSS before any visible text, pushing the OTP past the old scan window entirely
const LIST_LIMIT = 50;
